<html lang="en" style="height: auto;"><head>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper" style="min-height: 69px; margin-bottom: 55px;">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right" sr>
